...
begin
  ...
  ADOConnectDM.WaitTimesADOT.Active:=False;
  ADOConnectDM.WaitTimesADOT.Active:=True;
  ADOConnectDM.DailyParamsADOT.Active:=False;
  ADOConnectDM.DailyParamsADOT.Active:=True;
  ADOConnectDM.RatingLevelsADOT.Active:=False;
  ADOConnectDM.RatingLevelsADOT.Active:=True;
...
begin
  ShellExecute(PrSettForm.Handle, 'open',
    ...
    'адрес_сервиса_выделения_зоны_тарифа',
