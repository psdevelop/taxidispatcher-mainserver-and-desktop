...
begin
  ...
  try
    ...
    ShowMessage('Неудачное обновление'+
      ' таблицы групп водителей!'+
      E.Message);
  end;
  ...
  try
    ...
    ShowMessage('Неудачное обновление'+
      ' таблицы панели администрирования'+
      ' удаленного доступа! '+E.Message);
  end;
end;
...
begin
  ...
  (Column.FieldName =  'EN_MOVING') or (Column.FieldName =  'use_dyn_balance')
    ...
    or (Column.FieldName =  'is_our') or (Column.FieldName =  'manual_day_sale') or (Column.FieldName =  'require_gps') then // Модифицируйте под себя
...
begin
  ...
  (SelectedField.FieldName =  'EN_MOVING') or (SelectedField.FieldName =  'use_dyn_balance')
    ...
    or (SelectedField.FieldName =  'is_our') or (SelectedField.FieldName =  'manual_day_sale') or (SelectedField.FieldName =  'require_gps') then // Модифицируйте под себя
