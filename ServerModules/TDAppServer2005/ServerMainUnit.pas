    ...
    begin
      ...
      if StateRequestResult=1 then
        begin
          ...
          if RemoteControlForm.SettingsADODS.Active then
          begin
            if RemoteControlForm.SettingsADODS.RecordCount>0 then
              if RemoteControlForm.SettingsADODS.FieldByName('use_call_robot').AsInteger>=1 then
              begin
                SmsSendForm.CheckRobotCalling;
              end;
          end;
        end
